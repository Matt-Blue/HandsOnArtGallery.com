...
class RequestController extends Controller
{
    ...
    public function Create(Request $request){
        ...
        $request = new \HandsOnArtGallery.com\Request;
    ...
    public function Update($id, Request $request){
        ...
        // Create request with attributes and save in database
        $request = \HandsOnArtGallery.com\Request::find($id);
        $this->Save($request, $attributes);
    ...
    public function Delete($id){
        ...
        \HandsOnArtGallery.com\Event::destroy($id);
    ...
    public function Auth($id){
        ...
        // Create request with attributes and save in database
        $request = \HandsOnArtGallery.com\Request::where('event_id',$id)->first();
        $request->status = 1;
        $request->save();
