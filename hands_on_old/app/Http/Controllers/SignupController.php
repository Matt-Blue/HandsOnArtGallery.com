...
//************SIGNUP CRUD SECTION************//
    ...
    public function Create($event_id){
        ...
        if($this->CheckUnpaid($event_id) === "valid"){
            ...
            $signup = new \HandsOnArtGallery.com\Signup;
    ...
    public function Delete($id){
        ...
        // \HandsOnArtGallery.com\Signup::destroy($id);
...
//***********SAVE AND VALIDATE SECTION***********//
    ...
    public function CheckUnpaid($event_id){
        ...
        elseif(\HandsOnArtGallery.com\Event::find($event_id) === null){ return "Event does not exist."; }
